      ...
      <tr>
          ...
          <div class="info-content">
            ...
            <div style="margin-top: 5px;">
              <div style="margin-bottom: 2px;"><span
                  style="color: #7f8c8d; width: 60px; display: inline-block;">User:</span>
                <strong>{{ $issue->outlet->name ?? '' }}</strong>
              </div>
              <div style="margin-bottom: 2px;"><span
                  style="color: #7f8c8d; width: 60px; display: inline-block;">Phone:</span>
                <strong>{{ $issue->outlet->phone ?? 'N/A' }}</strong>
              </div>
              <div style="margin-bottom: 2px;"><span
                  style="color: #7f8c8d; width: 60px; display: inline-block;">Email:</span>
                <strong>{{ $issue->outlet->email ?? 'N/A' }}</strong>
              </div>
              <div style="margin-bottom: 2px;"><span
                  style="color: #7f8c8d; width: 60px; display: inline-block; vertical-align: top;">Address:</span>
                <strong style="display: inline-block; width: 220px;">{{ $issue->outlet->address ?? 'N/A' }}</strong>
              </div>
            </div>
          </div>
        </td>
        <td style="width: 50%; vertical-align: top;">
          ...
          <div class="info-content text-right" style="text-align: right;">
            <div style="margin-bottom: 2px;"><span style="color: #7f8c8d;">Date:</span>
              <strong>{{ $issue->created_at->format('d M, Y h:i A') }}</strong>
            </div>
            <div style="margin-bottom: 2px;"><span style="color: #7f8c8d;">Request Ref:</span>
              <strong>{{ $issue->productRequest->request_no ?? 'N/A' }}</strong>
            </div>
            <div style="margin-bottom: 2px;"><span style="color: #7f8c8d;">Issued By:</span>
    ...
    <table class="items-table">
      ...
      <tbody>
        ...
        <tr style="background-color: #f8f9fa;">
          <td colspan="4"
            style="padding: 8px 12px; font-weight: bold; text-transform: uppercase; font-size: 11px; color: #2c3e50; border-bottom: 1px solid #ecf0f1;">
            {{ $categoryName }}
          </td>
        </tr>
        ...
        <tr>
          ...
          <td class="image-cell">
            ...
            <img
              src="{{ str_starts_with((string) $item->product->thumb_image, 'http') ? $item->product->thumb_image : asset('storage/' . ltrim((string) $item->product->thumb_image, '/')) }}"
