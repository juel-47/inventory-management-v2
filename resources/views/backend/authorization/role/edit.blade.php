            ...
            <div class="col-12">
                <div class="card pp-card">
                    <div class="pp-card-header">
                        <h4><i class="fas fa-shield-alt"></i> Edit Role Details</h4>
                    </div>
                        ...
                        <form action="{{ route('admin.role.update', $role->id) }}" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-4">
                                    ...
                                    <input type="text" class="form-control pp-input" id="role_name" name="name" value="{{ old('name', $role->name) }}" placeholder="Enter role name">
                                </div>
                                <div class="col-md-8">
                                            ...
                                            <div class="col-md-6 col-lg-4">
                                                <div class="pp-permission-card">
                                                    ...
                                                    <label class="custom-switch pp-toggle mt-0">
                                                        <input type="checkbox" name="permissions[]" value="{{ $item->id }}" class="custom-switch-input" {{ $checked ? 'checked' : '' }}>
