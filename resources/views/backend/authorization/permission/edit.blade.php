...
@section('title', $settings->site_name . ' | Edit Permission')
                ...
                <div class="col-12">
                    <div class="card pp-card">
                        <div class="pp-card-header">
                            <h4><i class="fas fa-pen-fancy"></i> Update Permission</h4>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control pp-input" id="permissionName" name="name"
                                            value="{{ old('name') ?? $permission->name }}" placeholder="e.g. edit_users, view_reports">
                                    </div>
                                </div>
