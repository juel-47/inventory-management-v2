...
@section('title', $settings->site_name . ' | Create Brand')
...
<style>
    ...
    .pp-hint i { margin-right: 4px; color: var(--pp-amber); }
    ...
    @media (max-width: 767.98px) {
        ...
        .pp-input, .pp-select { font-size: 11.5px !important; padding: 7px 12px !important; height: 38px !important; }
        .pp-btn { width: 100%; justify-content: center !important; }
    }
</style>
@endpush
...
@section('content')
    <section class="section">
        <div class="pp-header">
            ...
            <div>
                <a href="{{ route('admin.brand.index') }}" class="btn pp-btn pp-btn-outline shadow-sm">
                ...
                <div class="col-12">
                    <div class="card pp-card">
                        <div class="pp-card-header">
                            <h4><i class="fas fa-building"></i> New Brand Details</h4>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label for="inputName" class="form-label">
                                            <i class="fas fa-tag mr-1" style="color: var(--pp-amber);"></i> Brand Name
                                            <span class="text-danger">*</span>
                                        </label>
                                        <input type="text" class="form-control pp-input @error('name') is-invalid @enderror" id="inputName"
                                            name="name" value="{{ old('name') }}" placeholder="e.g. Nike, Adidas, Samsung">
                                        @error('name')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        <small class="pp-hint"><i class="fas fa-info-circle"></i> A unique name for the brand</small>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="inputState" class="form-label">
                                            <i class="fas fa-toggle-on mr-1" style="color: var(--pp-amber);"></i> Status
                                            <span class="text-danger">*</span>
                                        </label>
                                        <select id="inputState" class="form-control pp-select @error('status') is-invalid @enderror" name="status">
                                        ...
                                        @error('status')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        <small class="pp-hint"><i class="fas fa-info-circle"></i> Active brands are visible to customers</small>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-end mt-4 pt-3" style="border-top: 1px solid var(--pp-border);">
