...
@section('title', $settings->site_name . ' | Update Brand')
...
@section('content')
    <section class="section">
        <div class="pp-header">
            <h1>
                <span class="pp-icon"><i class="fas fa-edit"></i></span>
                Update Brand
            </h1>
            <div>
                ...
                <div class="col-12">
                    <div class="card pp-card">
                        <div class="pp-card-header">
                            <h4><i class="fas fa-building"></i> Edit Brand Details</h4>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label for="inputName" class="form-label">
                                            <i class="fas fa-tag mr-1" style="color: var(--pp-amber);"></i> Name
                                            <span class="text-danger">*</span>
                                        </label>
                                        <input type="text" class="form-control pp-input @error('name') is-invalid @enderror" id="inputName"
                                            name="name" value="{{ old('name', $brand->name) }}" placeholder="e.g. Nike, Adidas, Samsung">
                                        @error('name')
