...
<head>
    <meta charset="UTF-8">
    <title>Purchase Payment History</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <div class="meta">Purchase Payment History • Generated: {{ $generatedAt->format('d M, Y h:i A') }}</div>
        </div>
        ...
        <table>
            <tbody>
                ...
                <tr>
                    <th>Vendor</th>
                    <td>{{ $purchase->vendor->shop_name ?? '-' }}</td>
                    <th>Phone</th>
        ...
        <div class="summary">
            ...
            <strong>Purchase Paid:</strong> {{ $settings->currency_icon }}{{ number_format($summary['paid_amount'], 2) }} |
            <strong>Purchase Due:</strong> {{ $settings->currency_icon }}{{ number_format($summary['due_amount'], 2) }}
        </div>
    </div>
</body>
</html>
