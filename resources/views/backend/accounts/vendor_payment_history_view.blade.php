...
<head>
    ...
    <style>
        ...
        .container { max-width: 980px; margin: 20px auto; background: #fff; padding: 20px 24px; border-radius: 6px; box-shadow: 0 8px 24px rgba(15, 23, 42, 0.08); }
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <div class="meta">Vendor Payment History • Generated: {{ $generatedAt->format('d M, Y h:i A') }}</div>
        </div>

        <div class="filters">
            <strong>Filters:</strong>
            <span>Vendor: {{ $filters['vendor_name'] ?: 'All' }}</span> |
