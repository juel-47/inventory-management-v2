...
<body>
    <div class="header">
        ...
        <div class="meta">Payment Details • Generated: {{ $generatedAt->format('d M, Y h:i A') }}</div>
    </div>
    ...
    <table>
        <tbody>
            <tr>
                ...
                <td>{{ $payment->order?->created_at?->format('d M, Y h:i A') ?? '-' }}</td>
            </tr>
            <tr>
                <th>Customer</th>
            ...
            <tr>
                <th>Email</th>
                <td>{{ $payment->order->billing_email ?? '-' }}</td>
                <th>Outlet/Shop</th>
                <td>{{ $payment->order->billing_outlet_name ?? '-' }}</td>
            </tr>
        </tbody>
    </table>
